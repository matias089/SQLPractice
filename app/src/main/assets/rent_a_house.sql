/* CREACION DE USUARIOS SI ESTA TRABAJANDO CON ORACLE XE */ GRANT CREATE SESSION TO MDY2131_RH;

GRANT "RESOURCE" TO MDY2131_RH;

/* CREACION DE USUARIOS SI ESTA TRABAJANDO CON ORACLE CLOUD COMO USUARIO ADMIN */ GRANT CREATE SESSION TO MDY2131_RH;

GRANT "RESOURCE" TO MDY2131_RH;

/* CONECTADO COMO USUARIO MDY2131_RH SE PUEDEN CREAR LAS TABLAS */ DROP TABLE ESTADO_CIVIL CASCADE CONSTRAINTS;
...
CREATE TABLE comuna (id_comuna INTEGER NOT NULL, nombre_comuna TEXT NOT NULL, CONSTRAINT pk_comuna PRIMARY KEY (id_comuna));

CREATE TABLE categoria_empleado (id_categoria_emp INTEGER NOT NULL, desc_categoria_emp TEXT NOT NULL, CONSTRAINT pk_categoria_empleado PRIMARY KEY (id_categoria_emp));

CREATE TABLE tipo_propiedad (id_tipo_propiedad TEXT NOT NULL, desc_tipo_propiedad TEXT NOT NULL, CONSTRAINT pk_tipo_propiedad PRIMARY KEY (id_tipo_propiedad ));

CREATE TABLE estado_civil (id_estcivil INTEGER NOT NULL, desc_Estcivil TEXT Not Null, CONSTRAINT pk_estado_civil PRIMARY KEY(id_estcivil));

CREATE TABLE propietario (numrut_prop INTEGER Not Null, dvrut_prop TEXT NOT NULL, appaterno_prop TEXT NOT NULL, apmaterno_prop TEXT NOT NULL, nombre_prop TEXT NOT NULL, direccion_prop TEXT NOT NULL, id_estcivil INTEGER NOT NULL, fonofijo_prop TEXT NOT NULL, celular_prop TEXT, id_Comuna INTEGER, CONSTRAINT pk_propietario PRIMARY KEY (numrut_prop));

CREATE TABLE cliente (numrut_cli INTEGER NOT NULL, dvrut_cli TEXT NOT NULL, appaterno_cli TEXT NOT NULL, apmaterno_cli TEXT NOT NULL, nombre_cli TEXT NOT NULL, direccion_cli TEXT NOT NULL, id_estcivil INTEGER NOT NULL, fonofijo_cli INTEGER NOT NULL, celular_cli INTEGER, renta_cli INTEGER NOT NULL, CONSTRAINT pk_cliente PRIMARY KEY (numrut_cli));

CREATE TABLE empleado (numrut_emp INTEGER NOT NULL, dvrut_emp TEXT NOT NULL, cod_emp INTEGER NOT NULL, appaterno_emp TEXT NOT NULL, apmaterno_emp TEXT NOT NULL, nombre_emp TEXT NOT NULL, direccion_emp TEXT NOT NULL, id_estcivil INTEGER NOT NULL, fonofijo_emp TEXT NOT NULL, celular_emp TEXT, fecnac_emp TEXT, fecing_emp TEXT NOT NULL, sueldo_emp INTEGER NOT NULL, id_comuna INTEGER, id_categoria_emp INTEGER, numrut_supervisor INTEGER, CONSTRAINT pk_empleado PRIMARY KEY (numrut_emp));

CREATE TABLE propiedad (nro_propiedad INTEGER NOT NULL, direccion_propiedad TEXT NOT NULL, superficie INTEGER(8,2) NOT NULL, nro_dormitorios INTEGER, nro_banos INTEGER, valor_arriendo INTEGER NOT NULL, valor_gasto_comun INTEGER, id_tipo_propiedad TEXT NOT NULL, id_comuna INTEGER NOT NULL, numrut_prop INTEGER NOT NULL, numrut_emp INTEGER, CONSTRAINT pk_propiedad PRIMARY KEY (nro_propiedad));

CREATE TABLE propiedad_arrendada (nro_propiedad INTEGER NOT NULL, fecini_arriendo TEXT NOT NULL, fecter_arriendo TEXT, numrut_cli INTEGER NOT NULL, CONSTRAINT pk_propiedad_arrendada PRIMARY KEY (nro_propiedad,fecini_arriendo));

ALTER TABLE empleado ADD ) REFERENCES comuna (id_comuna);

ALTER TABLE propietario ADD ) REFERENCES comuna (id_comuna);

ALTER TABLE empleado ADD ) REFERENCES categoria_empleado (id_categoria_emp);

ALTER TABLE empleado Add ) REFERENCES empleado (numrut_emp);

ALTER TABLE propiedad ADD ) REFERENCES tipo_propiedad (id_tipo_propiedad);

ALTER TABLE propiedad ADD ) REFERENCES comuna (id_comuna);

ALTER TABLE propiedad ADD ) REFERENCES propietario (numrut_prop);

ALTER TABLE propiedad ADD ) REFERENCES empleado (numrut_emp);

ALTER TABLE propiedad_arrendada ADD ) REFERENCES cliente(numrut_cli);

ALTER TABLE propiedad_arrendada ADD ) REFERENCES propiedad(nro_propiedad);

ALTER TABLE propietario ADD ) REFERENCES estado_civil (id_estcivil);

ALTER TABLE cliente ADD ) REFERENCES estado_civil (id_estcivil);

ALTER TABLE empleado ADD ) REFERENCES estado_civil (id_estcivil);
...
INSERT INTO propiedad_arrendada VALUES (1005,'02032008','0203' || TO_CHAR(SYSTEXT,'YYYY'),12186256);

INSERT INTO propiedad_arrendada VALUES (1005,'0104' || TO_CHAR(SYSTEXT,'YYYY'),NULL,15353262);
...
INSERT INTO propiedad_arrendada VALUES (1021,'03052010','3103' || TO_CHAR(SYSTEXT,'YYYY'),15353262);
...
INSERT INTO propiedad_arrendada Values (1026,'01102017','3112' || TO_CHAR(TO_CHAR(SYSTEXT,'YYYY')-1),11635470);

/* GENERACION DE ESTADISTICAS DE LAS TABLAS EN LA LA BASE DE DATOS NECESARIAS PARA GENERAR PLANES DE EJECUCIÓN Y TRABAJAR CON ÍNDICES */ EXEC DBMS_STATS.GATHER_TABLE_STATS (ownname => '"MDY2131_RH"',tabname => '"ESTADO_CIVIL"',estimate_percent => 100);
